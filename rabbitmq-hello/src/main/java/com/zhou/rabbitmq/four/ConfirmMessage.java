package com.zhou.rabbitmq.four;
...
public class ConfirmMessage {
    ...
    public static void main(String[] args) throws Exception {
        //1. 单个确认
//        ConfirmMessage.publishMessageIndividually();    //发布1000个单独确认消息,耗时330ms
        //2. 批量确认
//        ConfirmMessage.publishMessageBatch();  //发布1000个批量确认消息,耗时54ms
        //3. 异步批量确认
